...
<ul>
   ...
   <li id="destaques"><a href='#'><span>Destaques</span></a>
      <ul>
         ...
         <li class='has-sub'><a href='pesquisa.php5'><span>Destaque 2
         <p></p>
...
<div class="titulo-postagem"> <a href="#">Nome do evento</a>
...
<h3 class="detalhes-basicos-postagem">
<img src="imagens/icon-calendario2.png"> 02 de novembro de 2014 - 18:00  |<img src="imagens/icon-cifrao-3d.png">R$ 45,00 a R$ 150,00 | 
...
<div class="descricao-evento">Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento / Descrição do evento</div>

<div class="fb-comments" data-href="http://localhost/Site_vers%C3%A3o1.7.0/pesquisa2.html" data-width="620" data-numposts="3" data-colorscheme="light"></div>
